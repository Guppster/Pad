...
public class MenuCreator extends JMenuBar 
{
    ...
    //Set the keyboard shortcut for the menu item
    public void setShortcut(int keyEvent, int keyEventMask1, int keyEventMask2, int actionEvent)
    {
    	menuItemReference.setAccelerator(KeyStroke.getKeyStroke(keyEvent, actionEvent));
    }//End of method  	
}//End of class