...
public class DocumentBrowser extends JFrame implements ActionListener
{
    ...
    private void setGUI()
    {
		...
		layout.putConstraint(SpringLayout.WEST, cmdSortByName, 440, SpringLayout.WEST, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.WEST, cmdSortByCharacters, 440, SpringLayout.WEST, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.WEST, cmdSortByWords, 440, SpringLayout.WEST, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.WEST, cmdSortBySentences, 440, SpringLayout.WEST, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.WEST, cmdSearch, 440, SpringLayout.WEST, this.getContentPane());
