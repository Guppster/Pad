...
public class Lobby extends JFrame implements ActionListener
{
    ...
    private void setGUI()
    {
		...
		layout.putConstraint(SpringLayout.NORTH, cmdBrowse, 90, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdCheckForUpdates, 130, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdCreate, 170, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdLogout, 200, SpringLayout.NORTH, this.getContentPane());
