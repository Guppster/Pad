...
public class Lobby extends JFrame implements ActionListener
{
	...
	//Constructor
    public Lobby(User user, Client client)
    {
    ...
    private void setGUI()
    {
		...
		layout.putConstraint(SpringLayout.NORTH, cmdBrowse, 110, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdCheckForUpdates, 150, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdCreate, 190, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdLogout, 220, SpringLayout.NORTH, this.getContentPane());
