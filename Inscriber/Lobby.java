...
public class Lobby extends JFrame implements ActionListener
{
    ...
    private void setGUI()
    {
		...
		layout.putConstraint(SpringLayout.NORTH, cmdBrowse, 70, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdCheckForUpdates, 120, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdCreate, 150, SpringLayout.NORTH, this.getContentPane());
		...
		layout.putConstraint(SpringLayout.NORTH, cmdLogout, 180, SpringLayout.NORTH, this.getContentPane());
